...
Query the value of the object.  These packages are based on the idea of moving
"moving" computations.  If the intended size of the vectors -- that set by
L</set_size()> -- isn't yet met, this function will return the undefined value,
rather than the calculated object value.
...
L</set_size()>.  This function returns a list, i.e.:
    ...
    my @s = $obj->size; # two values
    my $s = $obj->size; # the right hand value of the list
...
print a pretty value for the object (or C<n/a>, see L</query()> above).
